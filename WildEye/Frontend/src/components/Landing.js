                ...
                <div className="col-lg-5 mr-auto" data-aos="fade-up">
                  <div className="owl-carousel slide-one-item-alt-text">
                    ...
                    <div className="slide-text">
                      <h1>WildEye</h1>
                      <p className="mb-5">Welcome to our Wildlife Monitoring and Conservation project, where we harness the power of computer vision to safeguard endangered species and their habitats. Our innovative system uses advanced deep learning models to automatically detect, identify, and track wildlife in real-time, providing critical insights for conservationists and wildlife managers.</p>
              ...
              <div className="row">
                ...
                <div className="col-lg-5 mr-auto mb-5"  data-aos="fade-up">
                  <div className="mb-5">
                    ...
                    <p className="black-text">WildEye is a wildlife species identification and offence registration web app.<br/>In the WildEye system, images captured by cameras or other devices are passed as input to the model for object detection and recognition. By feeding the images through the trained model, WildEye can identify and localize wildlife species present in the images.
                    </p>
          ...
          <footer className="footer-section bg-dark">
            <div className="container">
              <div className="row">
                ...
                <div className="col-md-4">
                  <h3>Project</h3>
                  <p>This is a project we made as a part of our SEM 7 PBL-V curriculum.</p>
                </div>
